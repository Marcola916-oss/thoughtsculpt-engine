...
const PT: Dict = {
  ...
  common: {
    ...
    securePayment: "Pagamento seguro via Stripe", processing: "Processando…", analyzing: "a analisar",
  ...
  sales: {
    ...
    painBlock: {
      ...
      bullets: [
        "A tua conta desaparece antes do fim do mês e não sabes exactamente para onde foi.",
...
const EN: Dict = {
  ...
  common: {
    ...
    securePayment: "Secure payment via Stripe", processing: "Processing…", analyzing: "analyzing",
  ...
  salesV2: {
    ...
    b2: {
      ...
      bullets: [
        "Money: Your account disappears before the end of the month and you don't know exactly where it went.",
        "Money: You make financial decisions that you know are wrong... and you keep making them.",
        "Career: You accept less than you deserve or jump from project to project without closing cycles.",
        "Career: The raise arrived, but the feeling of instability stayed exactly the same.",
        "Love: You avoid conversations about money with those you love — until they explode for some other reason.",
        "Love: You compare yourself on Instagram and feel that the good life always happens to others.",
        "Personal: Healthy habits (gym, reading, sleep) last less than the initial euphoria.",
        "Personal: Every new attempt starts with conviction and ends with the same phrase — 'this time it will be different'.",
      ],
...
const PL: Dict = {
  ...
  common: { ...EN.common,
    ...
    securePayment: "Bezpieczna płatność przez Stripe", processing: "Przetwarzanie…", analyzing: "analizuję",
  },
  login: {
  ...
  salesV2: {
    ...
    b2: {
      ...
      bullets: [
        "Pieniądze: A tua conta desaparece antes do fim do mês e não sabes exactamente para onde foi.",
        "Pieniądze: Tomas decisões financeiras que sabes que estão erradas… e continuas a tomá-las.",
        "Kariera: Aceitas menos do que mereces ou saltas de projecto em projecto sem fechares ciclos.",
        "Kariera: O aumento chegou, mas a sensação de instabilidade ficou exactamente igual.",
        "Miłość: Evitas conversas sobre dinheiro com quem amas — até que explodem por outro motivo qualquer.",
        "Miłość: Comparas-te no Instagram e sentes que a vida boa acontece sempre aos outros.",
        "Osobisty: Hábitos saudáveis (gym, leitura, sono) duram menos do que a euforia inicial.",
        "Osobisty: Cada nova tentativa começa com convicção e acaba com a mesma frase — 'desta vez vai ser diferente'.",
      ],
...
const RO: Dict = {
  ...
  common: { ...EN.common,
    ...
    securePayment: "Plată securizată prin Stripe", processing: "Se procesează…", analyzing: "analizez",
  },
  login: {
  ...
  salesV2: {
    ...
    b2: {
      ...
      bullets: [
        "Bani: A tua conta desaparece antes do fim do mês e não sabes exactamente para onde foi.",
        "Bani: Tomas decisões financeiras que sabes que estão erradas… e continuas a tomá-las.",
        "Carieră: Aceitas menos do que mereces ou saltas de projecto em projecto sem fechares ciclos.",
        "Carieră: O aumento chegou, mas a sensação de instabilidade ficou exactamente igual.",
        "Iubire: Evitas conversas sobre dinheiro com quem amas — até que explodem por outro motivo qualquer.",
        "Iubire: Comparas-te no Instagram e sentes que a vida boa acontece sempre aos outros.",
        "Personal: Hábitos saudáveis (gym, leitura, sono) duram menos do que a euforia inicial.",
        "Personal: Cada nova tentativa começa com convicção e acaba com a mesma frase — 'desta vez vai ser diferente'.",
      ],
...
const AR: Dict = {
  ...
  common: { ...EN.common,
    ...
    securePayment: "دفع آمن عبر Stripe", processing: "جارٍ المعالجة…", analyzing: "جارٍ التحليل",
  },
  login: {
  ...
  salesV2: {
    ...
    b2: {
      ...
      bullets: [
        "المال: A tua conta desaparece antes do fim do mês e não sabes exactamente para onde foi.",
        "المال: Tomas decisões financeiras que sabes que estão erradas… e continuas a tomá-las.",
        "المسيرة: Aceitas menos do que mereces ou saltas de projecto em projecto sem fechares ciclos.",
        "المسيرة: O aumento chegou, mas a sensação de instabilidade ficou exactamente igual.",
        "الحب: Evitas conversas sobre dinheiro com quem amas — até que explodem por outro motivo qualquer.",
        "الحب: Comparas-te no Instagram e sentes que a vida boa acontece sempre aos outros.",
        "الشخصي: Hábitos saudáveis (gym, leitura, sono) duram menos do que a euforia inicial.",
        "الشخصي: Cada nova tentativa começa com convicção e acaba com a mesma frase — 'desta vez vai ser diferente'.",
      ],
