...
const AR: Dict = {
  ...
  salesV2: {
    ...
    b3: {
      ...
      proofSeal: "مبني على 14 دراسة محكّمة · 12,000 تشخيص مُتحقَّق منه في 5 دول",
    ...
    b4: {
      ...
      features: [
        ...
        { title: "الشخصي", description: "العادة-المرساة التي إن غيّرتها أسقطت 3 أنماط تلقائية أخرى خلال 90 يوماً." },
      ],
    },
    b5: {
      eyebrow: "ما ستحصل عليه",
      title: "كل ما تحتاجه للخروج من نمط [PRIMARY].",
      subtitle: "ستة عناصر تعمل معاً — مبنية خصيصاً لنمطك.",
      deliverables: [
        { title: "تشخيص 4D مخصّص", description: "خريطة نمطك في المجالات الأربعة الحرجة — المال، المسيرة، الحب، الشخصي — بدرجات حقيقية." },
        { title: "بروتوكول 90 يوماً", description: "30 إجراءً صغيراً مُعايَراً لتعطيل محفّز [PRIMARY] في كل مجال، أسبوعاً بأسبوع." },
        ...
        { title: "تقارير شهرية", description: "ترى المنحنى الحقيقي لسلوكك، شهراً بشهر، بلا خداع للذات أو قصص مريحة." },
    ...
    b6: {
      ...
      testimonials: [
        { quote: "لأول مرة فهمت لماذا لم أكن قادرة على الادخار. لم تكن قلة انضباط — كان نمطي [PRIMARY].", author: "Mariana S.", country: "البرتغال", arch: "AO" },
        ...
        { quote: "لم أفهم يوماً لماذا أحرق كل شيء قبل اليوم 15. التشخيص سمّى تماماً ما كنت أشعر به.", author: "Adam K.", country: "بولندا", arch: "HI" },
        { quote: "كنت أعتبر نفسي منضبطة مع المال. كشف لي MindReset أنني أخاف من الإنفاق — وهذه أيضاً مشكلة.", author: "Maria C.", country: "البرتغال", arch: "AO" },
        { quote: "أقسام المسيرة والعلاقات أوجعت — وكان عليّ النظر هناك بالضبط. ليس تقريراً، بل مرآة.", author: "Rami S.", country: "السعودية", arch: "EA" },
        { quote: "تلقّيت ملف PDF، قرأته ليلاً، وفي اليوم التالي رفضت عملية شراء كانت تلقائية. تفصيل صغير — تحوّل كبير.", author: "Ioana M.", country: "رومانيا", arch: "SS" },
        { quote: "أنا مهندسة، أحب البيانات. التشخيص لم يكن تنجيماً — كان مرآة مع مراجع أكاديمية في النهاية.", author: "Katarzyna W.", country: "بولندا", arch: "AO" },
        { quote: "ظننت أن المشكلة في الراتب. كانت في النمط. اليوم أكسب نفس المبلغ ولديّ هامش لأول مرة منذ 8 سنوات.", author: "Yousef A.", country: "السعودية", arch: "HI" },
      ],
    },
    ob1: {
      badge: "الأكثر إضافةً",
