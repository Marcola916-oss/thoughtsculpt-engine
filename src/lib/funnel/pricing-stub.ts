...
const TABLE: Record<FunnelCurrency, PriceTriplet> = {
  // bump2 alinhado à Bible V2 ($14 / equivalente local).
  BRL: { main: "R$ 49,90", bump1: "R$ 24,90", bump2: "R$ 69,90", totalWithBumps: "R$ 144,70", currency: "BRL", symbol: "R$" },
  USD: { main: "$9.90", bump1: "$4.99", bump2: "$14.00", totalWithBumps: "$28.89", currency: "USD", symbol: "$" },
  EUR: { main: "€9,90", bump1: "€4,99", bump2: "€14,00", totalWithBumps: "€28,89", currency: "EUR", symbol: "€" },
  PLN: { main: "39 zł", bump1: "19 zł", bump2: "55 zł", totalWithBumps: "113 zł", currency: "PLN", symbol: "zł" },
  RON: { main: "45 RON", bump1: "22 RON", bump2: "65 RON", totalWithBumps: "132 RON", currency: "RON", symbol: "RON" },
  SAR: { main: "SAR 37", bump1: "SAR 19", bump2: "SAR 52", totalWithBumps: "SAR 108", currency: "SAR", symbol: "SAR" },
};
