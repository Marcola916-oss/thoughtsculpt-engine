      ...
      >
        <Magnetic>
          ...
          >
            ...
            <span className="relative z-10 flex items-center justify-center px-5 sm:px-8 text-[clamp(1rem,4.2vw,1.75rem)] font-sans font-black tracking-tight whitespace-nowrap group-hover:text-white transition-colors">
