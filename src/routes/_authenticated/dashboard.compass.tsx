                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="family">{t.dashboard.compass.step1.relationshipFamily}</option>
                        <option value="general">{t.dashboard.compass.step1.relationshipGeneral}</option>
                      </select>
                    </div>
                  </div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  {activeAnalysis.target_name} — {
                    activeAnalysis.relationship_type === "romantic"
                      ...
                      ? t.dashboard.compass.result.typeProfessional
                      : activeAnalysis.relationship_type === "family"
                      ? t.dashboard.compass.result.typeFamily
