    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-transparent p-4 text-center">
        ...
        <div className="max-w-md space-y-6">
          <h2 className="font-display text-2xl font-black uppercase italic leading-[1.1] py-1 tracking-tight text-white">
        ...
        {isLocked && (
          <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-background/60 backdrop-blur-sm p-4 text-center">
            <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-2xl animate-in zoom-in-95 duration-300">
              ...
              <h2 className="mt-4 font-display text-2xl font-black uppercase italic leading-[1.1] py-1">{t.dashboard.layout.locked.heading}</h2>
