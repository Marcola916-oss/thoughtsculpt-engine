      ...
      <Reveal.Group className="grid grid-cols-1 gap-4 md:grid-cols-3" stagger="fast" amount={0.2}>
        {tt.items.map((item, i) => (
          <Reveal
            key={i}
            variant="fade-up"
            className="group flex flex-col gap-6 rounded-[2.5rem] border border-white/10 bg-black p-8 transition-all duration-500 hover:border-arch-primary/40 hover:bg-black/80 md:p-10 md:hover:-translate-y-2 shadow-2xl md:backdrop-blur-3xl"
          >
            <div
