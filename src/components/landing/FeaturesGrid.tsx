        ...
        {f.items.map((item, i) => {
          ...
          return (
            <Reveal
              key={i}
              variant="fade-up"
              className="group relative flex flex-col gap-5 rounded-3xl lg:rounded-[2.5rem] border border-white/10 bg-black p-8 transition-all duration-500 hover:border-arch-primary/40 hover:bg-black/80 md:p-12 md:hover:-translate-y-2 shadow-2xl will-change-transform lg:backdrop-blur-3xl"
            >
