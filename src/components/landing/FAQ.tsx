    ...
    >
      <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-20">
        <Reveal variant="fade-up" className="md:sticky md:top-32 md:self-start">
          ...
          <h2
            id="faq-title"
            className="font-display text-[24px] md:text-[24px] lg:text-[24px] font-black italic uppercase leading-[35px] tracking-[-0.05em] text-balance break-words text-center whitespace-pre-line"
          >
            {f.title}
          </h2>
