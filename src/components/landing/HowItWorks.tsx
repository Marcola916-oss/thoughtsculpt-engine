        ...
        {w.steps.map((step, i) => (
          <Fragment key={i}>
            ...
            >
              ...
              <h3 className="mb-3 font-display text-xl font-extrabold uppercase tracking-tight text-foreground group-hover:text-arch-primary transition-colors whitespace-pre-wrap">{step.title}</h3>
