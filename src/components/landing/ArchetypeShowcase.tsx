...
export function ArchetypeShowcase() {
  ...
  return (
    ...
    >
      ...
      <Reveal.Group
        className="grid grid-cols-1 overflow-hidden rounded-3xl lg:rounded-[2.5rem] border border-white/10 bg-black/60 md:backdrop-blur-3xl sm:grid-cols-2 lg:grid-cols-4 shadow-2xl"
        stagger="fast"
      >
        {ARCH_KEYS.map((key) => {
