  ...
  return (
    <section aria-labelledby="final-cta-title" className="relative overflow-hidden py-28 md:py-40">
      ...
      >
        <h2
          id="final-cta-title"
          className="font-display text-[clamp(1.5rem,8vw,5.25rem)] font-extrabold italic uppercase leading-[1.05] tracking-[-0.04em] text-foreground text-balance mx-[-18px] whitespace-pre-line"
        >
          {c.titleBefore}
        ...
        {onCta && (
          ...
          >
            ...
            <span className="relative z-10 flex items-center justify-center gap-6 text-[21px] md:text-[21px] font-extrabold uppercase tracking-tight group-hover:text-white transition-colors mx-[9px] pr-[9px]">
              {c.cta.toUpperCase()}
            </span>
