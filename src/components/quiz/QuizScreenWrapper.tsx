...
export function QuizScreenWrapper({
  ...
  return (
    <div className="relative flex flex-col items-center min-h-[calc(100dvh-2rem)] pt-3 pb-6 md:min-h-[70vh] md:justify-center md:py-6 w-full max-w-2xl mx-auto px-5 md:px-4 perspective-[1000px]">
