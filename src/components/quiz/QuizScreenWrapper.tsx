...
export function QuizScreenWrapper({
  ...
  return (
    <div className="relative flex flex-col items-center pt-3 pb-8 min-h-[calc(100vh-2rem)] md:min-h-[70vh] md:justify-center md:py-6 w-full max-w-2xl mx-auto px-5 md:px-4 perspective-[1000px]">
