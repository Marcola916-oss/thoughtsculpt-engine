...
export function ArchetypeRevealStage({
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-[92%] z-0 aspect-square w-[min(90vw,800px)] -translate-x-1/2 -translate-y-1/2 text-[var(--arch-edge)] opacity-[0.07]"
      >
