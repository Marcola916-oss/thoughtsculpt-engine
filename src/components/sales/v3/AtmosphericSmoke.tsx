...
const floorPuffs: Puff[] = [
  { left: 4, top: 50, width: 34, height: 38, opacity: 0.2, blur: 34, delay: -2, duration: 18, drift: 34 },
  { left: 18, top: 38, width: 38, height: 44, opacity: 0.17, blur: 42, delay: -10, duration: 25, drift: -42 },
  { left: 36, top: 46, width: 40, height: 40, opacity: 0.19, blur: 38, delay: -5, duration: 21, drift: 46 },
  { left: 56, top: 36, width: 42, height: 46, opacity: 0.18, blur: 44, delay: -14, duration: 28, drift: -38 },
  { left: 76, top: 48, width: 36, height: 38, opacity: 0.2, blur: 36, delay: -8, duration: 20, drift: 30 },
  { left: 92, top: 42, width: 32, height: 36, opacity: 0.14, blur: 40, delay: -17, duration: 26, drift: -34 },
];

const cradlePuffs: Puff[] = [
  { left: 50, top: 58, width: 60, height: 35, opacity: 0.8, blur: 34, delay: -1, duration: 8, drift: 12 },
  { left: 33, top: 62, width: 46, height: 31, opacity: 0.62, blur: 30, delay: -4, duration: 11, drift: -18 },
  { left: 67, top: 61, width: 48, height: 32, opacity: 0.64, blur: 31, delay: -6, duration: 10, drift: 16 },
  { left: 47, top: 72, width: 78, height: 28, opacity: 0.58, blur: 42, delay: -9, duration: 14, drift: -10 },
  { left: 55, top: 45, width: 40, height: 30, opacity: 0.34, blur: 38, delay: -3, duration: 13, drift: 9 },
  { left: 26, top: 78, width: 42, height: 24, opacity: 0.35, blur: 36, delay: -11, duration: 15, drift: 22 },
  { left: 75, top: 78, width: 44, height: 25, opacity: 0.36, blur: 36, delay: -12, duration: 16, drift: -24 },
];
